...
<!-- Scheduled, pre-dawn, results waiting when you wake. -->

## Why three sweeps, not one

<!-- A single broad query buries fit under keyword noise. Slice the market. -->

## Narrowing vs. repeating

<!-- How to structure queries so each sweep targets a distinct slice. -->

## The morning handoff

<!-- What lands in your inbox: scored, deduped, ranked. What you do with coffee. -->
