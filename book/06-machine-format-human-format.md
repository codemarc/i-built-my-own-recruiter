...
<!-- Agents reason over structure; humans skim visuals. -->

## TOON for machines

<!-- Token Oriented Object Notation: @section/@/section, key:value. Why it's compact. -->

## HTML for humans

<!-- Navigable, scannable in 90 seconds. -->

## Why a search of one still needs both

<!-- Future-you and future-agents are the second audience. Continuity. -->

## Setting up the dual-format convention

<!-- Generate both from one source. See templates/ for the TOON schema. -->
