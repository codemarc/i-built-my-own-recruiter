...
<!-- A great match plus a form letter equals nothing. -->

## Peer to peer, not applicant to gatekeeper

<!-- The tone shift that changes response rates. -->

## Capturing your voice

<!-- Feed the system real samples. What makes a draft sound like you. -->

## Editing, not rewriting

<!-- The bar: a draft you tweak, not one you redo. That's the trust threshold. -->

## The outreach template

<!-- See templates/ for the sanitized structure. -->
