...
<!-- Generic-everything vs. hand-craft-everything. Both break. -->

## Base resume as source of truth

<!-- One canonical version. Everything else derives from it. -->

## A repeatable tailoring process

<!-- Inputs: base + JD + rubric score. Output: company-specific version. -->

## When tailoring stops being the bottleneck

<!-- Fast enough that it's no longer the thing slowing you down. -->
