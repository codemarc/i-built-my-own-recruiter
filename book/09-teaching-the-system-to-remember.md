...
<!-- Speed alone re-surfaces the same roles you already rejected. -->

## What's worth remembering

<!-- Applied-to, declined + reason, rejection patterns, contacts. -->

## The memory layer

<!-- Where state lives, how it's written, how it's recalled next sweep. -->

## Getting smarter, not just faster

<!-- Feeding rejection patterns back into the rubric and the sweep. -->
