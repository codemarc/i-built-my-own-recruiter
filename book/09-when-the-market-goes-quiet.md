...
<!-- Eight quiet runs is data, not bad luck. -->

## Rubric problem or search problem?

<!-- Diagnosing which side is broken before you touch either. -->

## The uncomfortable signal

<!-- The role class itself might be structurally thin. -->

## Persistence vs. strategy

<!-- When to recalibrate the search instead of running it harder. -->
